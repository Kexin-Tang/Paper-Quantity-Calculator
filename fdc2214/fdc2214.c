...
uint8_t FDC2214_Init(void)
{
    ...
    if(deviceID == FDC2214_ID)
    {
        ...
        //FDC2214_SetActiveChannel(FDC2214_Channel_3);//开启通道3
        ...
        FDC2214_SetDriveCurrent(FDC2214_Channel_0, FDC2214_Drive_Current_0_146);//通道0驱动电流0.081mA
        FDC2214_SetDriveCurrent(FDC2214_Channel_1, FDC2214_Drive_Current_0_146);//通道1驱动电流0.081mA
        FDC2214_SetDriveCurrent(FDC2214_Channel_2, FDC2214_Drive_Current_0_146);//通道2驱动电流0.081mA
        FDC2214_SetDriveCurrent(FDC2214_Channel_3, FDC2214_Drive_Current_0_146);//通道3驱动电流0.081mA
    ...
    {
        LCD_ShowString(30,100,200,16,16,"Fail");
        LCD_ShowNum(30,120,deviceID,8,16);
    }
